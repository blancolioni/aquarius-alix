...
--     end Has_Simple_Format;
   ...
   procedure Set_Declaration (Item : in out Syntax_Tree_Record;
                              Dec  : in     Aquarius.Trees.Tree)
   is
   begin
      Item.Node.Declaration := Dec;
   end Set_Declaration;
