...
package Aquarius.Fonts is
   ...
   function Name (Font : Aquarius_Font) return String;
   function Size (Font : Aquarius_Font) return Natural;
   ...
   function Is_Strike_Through (Font : Aquarius_Font) return Boolean;
