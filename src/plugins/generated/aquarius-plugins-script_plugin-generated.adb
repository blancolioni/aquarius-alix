...
package body Aquarius.Plugins.Script_Plugin.Generated is
   ...
   package Bindings is
      procedure Actionable_plugin_declaration_Before_list_of_group_declarations (Target_Actionable : not null access Actions.Actionable'Class;
                                                                                 Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_group_declaration_Before_list_of_actions (Target_Actionable : not null access Actions.Actionable'Class;
                                                                     Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_group_declaration_After_list_of_actions (Target_Actionable : not null access Actions.Actionable'Class;
                                                                    Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_group_declaration_Before
        (Target_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_group_declaration_After
        (Target_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_action_Before_action_definition (Target_Actionable : not null access Actions.Actionable'Class;
                                                            Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_action_After_action_time (Target_Actionable : not null access Actions.Actionable'Class;
                                                     Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_action_After_action_context (Target_Actionable : not null access Actions.Actionable'Class;
                                                        Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_action_After_action_definition (Target_Actionable : not null access Actions.Actionable'Class;
                                                           Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_expression_After
        (Target_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_let_expression_After
        (Target_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_let_expression_After_binding (Target_Actionable : not null access Actions.Actionable'Class;
                                                         Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_call_expression_After
        (Target_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_call_expression_After_name (Target_Actionable : not null access Actions.Actionable'Class;
                                                       Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_arguments_After_expression (Target_Actionable : not null access Actions.Actionable'Class;
                                                       Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_call_expression_After_arguments (Target_Actionable : not null access Actions.Actionable'Class;
                                                            Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_binding_After_expression (Target_Actionable : not null access Actions.Actionable'Class;
                                                     Child_Actionable : not null access Actions.Actionable'Class);
      procedure Actionable_binding_After_identifier (Target_Actionable : not null access Actions.Actionable'Class;
                                                     Child_Actionable : not null access Actions.Actionable'Class);
   ...
   package body Bindings is
      procedure Actionable_plugin_declaration_Before_list_of_group_declarations (Target_Actionable : not null access Actions.Actionable'Class;
                                                                                 Child_Actionable : not null access Actions.Actionable'Class) is
      begin
         Aquarius.Plugins.Script_Plugin.Bindings.plugin_declaration_Before_list_of_group_declarations (Aquarius.Programs.Program_Tree
           (Target_Actionable), Aquarius.Programs.Program_Tree
           (Child_Actionable));
      end Actionable_plugin_declaration_Before_list_of_group_declarations;
      procedure Actionable_group_declaration_Before_list_of_actions (Target_Actionable : not null access Actions.Actionable'Class;
                                                                     Child_Actionable : not null access Actions.Actionable'Class) is
      begin
      ...
      procedure Actionable_group_declaration_Before
        (Target_Actionable : not null access Actions.Actionable'Class) is
      begin
   ...
   procedure Bind_Actions (Plugin : in out Script_Plugin_Type;
      ...
      Parser : Actions.Action_Group;
   begin
      Grammar.Add_Action_Group ("parser", Actions.Parse_Trigger,
                                Parser);
      Plugin.Register_Action ("plugin_declaration",
                              "list_of_group_declarations", Parser,
                              Aquarius.Before,
                              Bindings.Actionable_plugin_declaration_Before_list_of_group_declarations'access);
