...
package body Aquarius.Plugins.EBNF.Analyse is
   ...
   function Get_Syntax
     ...
     renames Aquarius.Trees.Properties.Get_Syntax;
   function Get_Syntax
   ...
   begin
      ...
      Option.Add_Child (Trees.Properties.Get_Syntax (Child.all));
      Trees.Properties.Set_Syntax (Tree.all, Option);
   ...
   begin
      Repeat.Add_Child (Aquarius.Trees.Properties.Get_Syntax (Child.all));
      Aquarius.Trees.Properties.Set_Syntax (Tree.all, Repeat);
   ...
   begin
      Aquarius.Trees.Properties.Set_Syntax
        (Tree.all, Aquarius.Trees.Properties.Get_Syntax (Child.all));

      if Separator_Child /= null then
         Tree.Set_Property
           (Global_Plugin.Separator,
            Aquarius.Trees.Properties.Get_Syntax (Separator_Child.all));
      end if;
   end After_Repeater;
