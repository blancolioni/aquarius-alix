...
package body Ada_Plugin.Generated is
   ...
   begin
      Grammar.Add_Action_Group ("parser", Aquarius.Actions.Parse_Trigger,
                                Parser);
      Grammar.Add_Action_Group ("generator", Aquarius.Actions.Code_Trigger,
                                Generator);
      Plugin.Register_Action ("defining_qualified_reference", Parser,
                              Aquarius.After,
      ...
      Plugin.Register_Action ("object_reference", Parser,
                              Aquarius.Before,
                              Names.Actionable_Object_Reference_Before'access);
      Plugin.Register_Action ("object_reference", Parser,
                              Aquarius.After,
                              Names.Actionable_Object_Reference_After'access);
      Plugin.Register_Action ("direct_name", Parser, Aquarius.After,
                              Names.Actionable_Direct_Name_After'access);
      Plugin.Register_Action ("expanded_name", Parser, Aquarius.After,
                              Names.Actionable_Expanded_Name_After'access);
      Plugin.Register_Action ("attribute_reference", Parser,
                              Aquarius.After,
                              Names.Actionable_Attribute_Reference_After'access);
      Plugin.Register_Action ("actual_argument_list", Parser,
                              Aquarius.After,
      ...
      Plugin.Register_Action ("numeric_literal", Parser,
                              Aquarius.After,
      ...
      Plugin.Register_Action ("block", Parser, Aquarius.Before,
                              Ch03.Actionable_Block_Before'access);
      Plugin.Register_Action ("list_of_declarations", Parser,
                              Aquarius.After,
                              Ch03.Actionable_List_Of_Declarations_After'access);
      Plugin.Register_Action ("relation", Parser, Aquarius.After,
                              Ch04.Actionable_Relation_After'access);
      Plugin.Register_Action ("simple_expression", Parser,
                              Aquarius.After,
                              Ch04.Actionable_Simple_Expression_After'access);
      Plugin.Register_Action ("term", Parser, Aquarius.After,
                              Ch04.Actionable_Term_After'access);
      Plugin.Register_Action ("factor", Parser, Aquarius.After,
                              Ch04.Actionable_Factor_After'access);
      Plugin.Register_Action ("factor", "not", Parser, Aquarius.After,
                              Ch04.Actionable_Factor_After_Not'access);
      Plugin.Register_Action ("primary", Parser, Aquarius.After,
                              Ch04.Actionable_Primary_After'access);
      Plugin.Register_Action ("boolean_operator", Parser,
                              Aquarius.After,
                              Ch04.Actionable_Boolean_Operator_After'access);
      Plugin.Register_Action ("relational_operator", Parser,
                              Aquarius.After,
                              Ch04.Actionable_Relational_Operator_After'access);
      Plugin.Register_Action ("binary_adding_operator", Parser,
                              Aquarius.After,
                              Ch04.Actionable_Binary_Adding_Operator_After'access);
      Plugin.Register_Action ("multiplying_operator", Parser,
                              Aquarius.After,
                              Ch04.Actionable_Multiplying_Operator_After'access);
      Plugin.Register_Action ("exponentation_operator", Parser,
                              Aquarius.After,
                              Ch04.Actionable_Exponentation_Operator_After'access);
      Plugin.Register_Action ("unary_adding_operator", Parser,
                              Aquarius.After,
                              Ch04.Actionable_Unary_Adding_Operator_After'access);
      Plugin.Register_Action ("unary_primary_operator", Parser,
                              Aquarius.After,
      ...
      Plugin.Register_Action ("assignment_statement", Parser,
                              Aquarius.After,
      ...
      Plugin.Register_Action ("compilation_unit", Parser,
                              Aquarius.Before,
                              Ch10.Actionable_Compilation_Unit_Before'access);
      Plugin.Register_Action ("with_clause", Parser, Aquarius.After,
