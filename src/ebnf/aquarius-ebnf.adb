...
package body Aquarius.EBNF is
   ...
   procedure Create_Terminals
     (Grammar : Aquarius.Grammars.Grammar_Type);
   ...
   function Create_EBNF_Grammar return Aquarius.Grammars.Grammar_Type is
      Grammar : constant Aquarius.Grammars.Grammar_Type :=
